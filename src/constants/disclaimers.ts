export const DISCLAIMER_SHORT =
  'This app does not sell or purchase lottery tickets. It provides ticket checking and analysis tools only. Results are for informational purposes and do not guarantee any outcome.';

export const DISCLAIMER_SUBSCRIPTION =
  'Analysis and simulation tools are for entertainment and decision support only. They do not increase or guarantee your chances of winning. Use at your own discretion. Pirate Plan is a one-time Compass purchase. Astronaut is an auto-renewing monthly subscription with an optional free trial for eligible new subscribers; cancel in Google Play before the trial ends to avoid charges.';
